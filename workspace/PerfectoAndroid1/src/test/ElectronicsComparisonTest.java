...
public class ElectronicsComparisonTest implements ApplicationConstants,PerfectoConstants{

	private IOSDriver<WebElement> driver;
	HomeScreenPageObject homeScreen;
	...
	//Using Data  Provider
	 ...
	 @BeforeMethod
		public void beforeTest(String mobileOS,String OSVersion,String deviceModel,String persona) throws IOException {
			...
			homeScreen = new HomeScreenPageObject(driver);
